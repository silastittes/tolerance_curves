...
post_params <- c("c", "d", "e", "maxima", "breadth", "area")
...
greek_params <- c(expression(delta), "maxima", expression(epsilon), expression(zeta))
...
spp_list %>%
  map(~{
    ...
    if(.x == "minor"){
      ...
      mtext(side = 1, "depth", line = 3, cex = 0.85)              
      }
  })
...
cairo_pdf(filename = paste0("figures/A", 3, ".pdf"))
plt_params(p = 1, den_rng = c(-6,6), -1, 1)
dev.off()

cairo_pdf(filename = paste0("figures/A", 4, ".pdf"))
plt_params(p = 2, den_rng = c(-6,6), -1, 1)
dev.off()

cairo_pdf(filename = paste0("figures/A", 5, ".pdf"))
plt_params(p = 3, den_rng = c(-3,3), 0, 1) 
dev.off()

cairo_pdf(filename = paste0("figures/A", 6, ".pdf"))
plt_params(p = 4, den_rng = c(-3,3), 0, 1) 
dev.off()

cairo_pdf(filename = paste0("figures/A", 7, ".pdf"))
plt_params(p = 5, den_rng = c(-3,3), 0, 1) 
dev.off()

cairo_pdf(filename = paste0("figures/A", 8, ".pdf"))
plt_params(p = 6, den_rng = c(-3,3), 0, 1) 
dev.off()

cairo_pdf(filename = paste0("figures/A", 9, ".pdf"))
plt_params(p = 7, den_rng = c(-3,3), 0, 1) 
dev.off()

cairo_pdf(filename = paste0("figures/A", 10, ".pdf"))

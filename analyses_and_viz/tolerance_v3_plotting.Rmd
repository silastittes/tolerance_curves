...
par_names <- c("area", "optima", "c", "d", "e", "c scaled")
...
for(i in 1:length(phy_sig)){
  ...
  legend("center", par_names[i], bty = "n", cex = 1.5)
...
plot_ou_den <- function( ou_data, colours, ... ){
...
oum_sim <- get_ouwie_mat(file_name = "derived_files/e1_OUM_simmap.txt")


#plot_ou_den(oum_ml, colours = colz)
plot_ou_den(oum_sim, colours = colz)
...
nodelabels(lasth$node.label, frame = "n", 
           cex = 0.8, font = 2, pos=4, offset = 1)

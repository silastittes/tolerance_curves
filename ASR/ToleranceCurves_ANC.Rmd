...
ouwie_c <- ouwie_draws(df = posts$c, draws = 100, mod = "OUM")
plot_ouwie_draws(ouwie_c)
compare_ouwie_draws(ouwie_c)

ouwie_e1 <- ouwie_draws(df = posts$e1, draws = 100, mod = "OUM")
plot_ouwie_draws(ouwie_e1)
compare_ouwie_draws(ouwie_e1)

ouwie_d <- ouwie_draws(df = posts$d, draws = 100, mod = "OUM")
plot_ouwie_draws(ouwie_d)
compare_ouwie_draws(ouwie_d)
